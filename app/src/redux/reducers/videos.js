 ...
 */
import { VIDEOS_FAILURE, GET_VIDEOS_REQUEST, ALL_VIDEOS, VIDEOS_REMOVE, PROJECT_DELETE_SUCCESS, LOGOUT_USER } from '../../constants';
...
function videos(state = initialState, action) {
    switch(action.type) {
        ...
        case PROJECT_DELETE_SUCCESS:
            var index = getArrayIndex(action.payload.projectId, state.videos);
