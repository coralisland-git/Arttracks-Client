...
function buildTrack(project, artwork, track, size, seconds, buildOrder) {
    var data = {
        "user": project.user,
        "project": project.id,
        "track": track.id,
    ...
    return sendRequest({
        ...
        fail: function(errorData) {
            if(errorData.details !== undefined) {
                ...
                return buildFail("We're sorry, this build order request has failed. Please contact customer support.");
            }
        }
    });
}
