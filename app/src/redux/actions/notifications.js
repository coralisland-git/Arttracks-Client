...
function getNotifications(cmdType) {
    ...
    return sendRequest({
        ...
        fail: function(errorData) {
            return failNotifications('Failed to get notifications.');
        }
    });
}
...
function updateNotification(cmdType, notification, options) {
    ...
    return sendRequest({
        ...
        fail: function(errorData) {
            return failNotifications('Failed to save notification.');
        }
    });
}
...
function removeNotification(cmdType, notificationId) {
    ...
    return sendRequest({
        ...
        fail: function(errorData) {
            return failNotifications('Failed to remove notification.');
        }
    });
}
