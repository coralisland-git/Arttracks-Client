...
export default class TrackItem extends React.Component {
    ...
    render() {
        ...
        let audio = null;
        if(track.audio_file)
            audio = <audio id={`audio_track_${track.id}`} loop><source src={track.audio_file.replace("http:", "https:")} type="audio/mpeg" /></audio>;
        ...
        return connectDragSource(connectDropTarget(
            <tr style={{opacity}} className={className}>
                ...
                <td className="cell-subtitle" onClick={drag ? null: editor}>{track.subtitle? track.subtitle: '----'}</td>
                ...
                <td className="text-right cell-actions">
                    ...
                    <Button bsStyle="link" className="pl1-imp pr1-imp action-drag-enable" onClick={enableDrag}>
                        <span className="rubix-icon icon-fontello-move"></span>
                    </Button>
